...
<!-- Mirrored from spboss.in/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Oct 2024 05:45:54 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>SATTA MATKA HEAD OFFICE SPBOSS OWNER CONTACT NUMBER</title>
<meta name="Description" content="How to contact us this information is given here feel free to ask anything this is contact page of spboss.in satta head office contact mobile number,SPBOSS net,SPBOSS medea, satta matta matka ,matka owner number how to contact SPBOSS
,satta matka company ka number,SPBOSS net facebook,SPBOSS vip" />
...
<div class="conta" style="display: block !important;">
<h4>Contact Details</h4>
<div class="row">
<div class="col-md-6" style="margin-top: 30px;">
<form action="https://spboss.in/php/email.php" id="ajax-contact" method="post" role="form">
<div class="messages" id="form-messages"></div>
<div class="controls">
<div class="row">
<div class="col-md-6">
<div class="form-group">
<label for="form_name" class="active">Customer Name *</label>
...
<div class="col-md-6">
<div class="form-group">
<label for="form_message">Game Type *</label>
...
<option value="Star Line Game">Star Line Game</option>
</select>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<label for="gamename" class="active">Game Name *</label>
<input id="form_gamename" type="text" name="gamename" class="form-control" placeholder="Please enter game you want *" required="required" data-error="Game name is required.">
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<label for="form_email" class="active">Email *</label>
...
<div class="col-md-6">
<div class="form-group">
<label for="form_phone" class="active">Contact No.*</label>
...
<div class="col-md-12">
<div class="form-group">
<label><input class="form-check-input" name="dosal_record" type="checkbox" id="dosal-record"> Do saal se adhik ka record</label>
</div>
</div>
<div class="col-md-12">
<input type="submit" class="btn btn-black" style="background: #ff9a34;color: white;font-weight: bold;" name="send_message" value="Send message">
</div>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="col-xs-9">
Matka HeadOffice, Kalyan,<br> Mumbai, Maharashtra 421301
</div>
</div>
<div class="row col1">
<div class="col-sm-3">
...
<div class="col-sm-9">
{{-- <a href="mailto:support@spboss.in">support@spboss.in</a> --}}
</div>
</div><br>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60271.51293772476!2d73.09512992742214!3d19.240158420331074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be796f457b1b76f%3A0x35df463ca445bd26!2sKalyan%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1651040963233!5m2!1sen!2sin" width="100%" height="250" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
</div>
</div>
<style>
